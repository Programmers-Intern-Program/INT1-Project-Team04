...
public final class MonitoringBriefingPromptTemplate {
    ...
    public static final String SYSTEM_PROMPT = """
            ...
            부동산 거래금액은 공공 API가 제공한 만원 단위 값입니다. 원 단위로 바꾸지 마세요.
            1억 이상 금액이 천만원 단위로 자연스럽게 떨어지면 "10.3억"처럼 소수 한 자리 억 단위로 쓰세요.
            천만원보다 상세한 나머지가 있으면 "10억 1231만원"처럼 억과 만원을 함께 쓰고, "10.1231억"처럼 긴 소수 억 표현은 사용하지 마세요.
            변화량이 1억 미만이면 "3000만원"처럼 만원 단위로 쓰세요.
